...
class DDoSDetector:
    """
    ANN-based DDoS Attack Detection Model
    Detects various DDoS attack types including DrDoS, SYN flood, UDP lag, etc.
    """
    ...
    def build_model(self):
        ...
        print(f"   Output: Binary (0=Benign, 1=DDoS Attack)")
    ...
    def evaluate(self, X_test, y_test):
        ...
        print(f"   DDoS      {cm[1][0]:6d}  {cm[1][1]:6d}")
    ...
    def plot_training_history(self, save_path='plots/ddos_training.png'):
        ...
        fig.suptitle('DDoS Detection Model - Training History', fontsize=16, fontweight='bold')
    ...
    def save_model(self, filepath='models/ddos_detector.keras'):
    ...
    @classmethod
    def load_model(cls, filepath='models/ddos_detector.keras'):
...
if __name__ == "__main__":
    print("DDoS Detection Model Module")
    print("ANN/MLP architecture for detecting various DDoS attacks")
