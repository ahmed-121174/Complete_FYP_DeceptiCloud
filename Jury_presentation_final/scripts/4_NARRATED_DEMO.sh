...
echo -e "  ${GREEN}DDoS ML Model:${RESET} ${DDOS_MODEL}  (95.88% accuracy on CIC-DDoS2019)"
...
print()
print('  Note: Model trained on CIC-DDoS2019 (12 attack categories, 95.88% accuracy)')
...
echo "        DDoS ML model: 95.88% accuracy on CIC-DDoS2019                  "
